...
merge buggy/broken/bad code into the main branch of your project.
The good news is: You don't have to! Let the machines do it for you automatically!
...
Add this file to your project repo, 
...
Once the workflow finishes, it will either have a green checkmark (✅ success) 
or a red x (❌ failure).
