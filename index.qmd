...
Generally, higher code coverage is better. However, 100% code coverage doesn't
guarantee that your code is free of bugs, and not all code strictly needs to be
tested.
Focus on writing unit tests that test your assumptions about how your
code works and test the most important components of your project.
